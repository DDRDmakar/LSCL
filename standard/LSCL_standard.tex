...
\end{minipage}
~\\
It's possible to use links instead of defining repeated objects. Link to the node is first identified by an ampersand sign ``\&'' and the following link name. Link could be referenced with an asterisk ``*'' thereafter. If link name could be any string. \\
